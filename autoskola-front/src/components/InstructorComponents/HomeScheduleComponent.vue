...
.modal-close-btn {
  ...
  font-size: 28px; color: #9C27B0; cursor: pointer;
  width: 32px; height: 32px;
  display: flex; align-items: center; justify-content: center;
  border-radius: 50%; transition: background-color 0.2s;
}
.modal-close-btn:hover { background-color: rgba(156, 39, 176, 0.1); }
...
.detail-label {
  ...
  width: 100px; flex-shrink: 0; font-size: 0.9rem;
}
...
.status-badge.future-accepted { background: #e8f5e9; color: #1b5e20; }
.status-badge.future-pending  { background: #fff3e0; color: #e65100; }
.status-badge.ongoing         { background: #f3e5f5; color: #4a148c; }
.status-badge.passed          { background: #f5f5f5; color: #393939; }
...
.record-btn:hover { background: #7B1FA2; }
...
.panel-section h4 {
  color: #3a283c; margin: 0 0 15px 0;
...
.upcoming-item {
  ...
  border-radius: 6px; border-left: 3px solid rgb(190, 143, 233);
  cursor: pointer; transition: all 0.2s;
}
.upcoming-item:hover { transform: translateX(2px); box-shadow: 0 2px 8px rgba(0,0,0,0.1); }

.upcoming-time { font-size: 0.8rem; color: rgb(190, 143, 233); font-weight: 600; margin-bottom: 2px; }
.upcoming-category { font-weight: 600; font-size: 0.9rem; margin-bottom: 2px; }
.upcoming-student { font-size: 0.8rem; color: #666; }
</style>